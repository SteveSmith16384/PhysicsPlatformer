...
public class JBox2DFunctions {
	...
	public static Body AddCircle(Object name, World world, float centre_x, float centre_y, float rad, 
			float weight_kgm2, float friction, float restitution) {
	...
	public static Body AddRectangleTL(Object name, World world, float x, float y, 
	...
	public static Body AddRectangle(Object name, World world, float centre_x, float centre_y, 
			float width, float height, BodyType bodytype, float restitution, float friction, float weight_kgm2) {
	 ...
	 * @return
	 */
	public static List<RevoluteJointDef> AddRopeShape(Object name, Object name_end, World world, IObjectList list, Body anchorBody, 
